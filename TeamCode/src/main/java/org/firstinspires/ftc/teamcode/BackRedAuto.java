...
@Autonomous(name="BackRedAuto", group="Yay...")
public class BackRedAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(86,20, Math.toRadians(66));
    private final Pose setUpPickUp1 = new Pose(90, 36, Math.toRadians(0));
    private final Pose pickUp1Pose = new Pose(125, 36, Math.toRadians(0));
    private final Pose startPickUp2Pose = new Pose(100, 60, Math.toRadians(0));
    private final Pose pickUp2Pose = new Pose(125, 60, Math.toRadians(0));
