...
@Autonomous(name="BackToFrontBlueAuto", group="Yay...")
public class BackToFrontBlueAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(60,79, Math.toRadians(45));
    private final Pose pickUp1Pose = new Pose(19, 83, Math.toRadians(0));
    private final Pose startPickUp2Pose = new Pose(60, 60, Math.toRadians(0));
    private final Pose endPickUp2Pose = new Pose(19, 60, Math.toRadians(0));
    private final Pose startPickUp3Pose = new Pose(60, 48, Math.toRadians(0));
    private final Pose endPickUp3Pose = new Pose(19, 48, Math.toRadians(0));
    private final Pose offWhiteLinePose = new Pose(96, 108, Math.toRadians(90));
