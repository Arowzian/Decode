...
@Autonomous(name="BackToFrontRedAuto", group="Yay...")
public class BackToFrontRedAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(84,79, Math.toRadians(45));
    private final Pose pickUp1Pose = new Pose(125, 83, Math.toRadians(0));
    private final Pose startPickUp2Pose = new Pose(84, 60, Math.toRadians(0));
    private final Pose endPickUp2Pose = new Pose(125, 60, Math.toRadians(0));
    private final Pose startPickUp3Pose = new Pose(84, 48, Math.toRadians(0));
    private final Pose endPickUp3Pose = new Pose(125, 48, Math.toRadians(0));
    private final Pose offWhiteLinePose = new Pose(84, 108, Math.toRadians(90));
