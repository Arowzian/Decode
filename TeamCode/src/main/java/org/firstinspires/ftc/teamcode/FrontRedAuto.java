...
@Autonomous(name="FrontRedQuot", group="Yay...")
public class FrontRedAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(86,79, Math.toRadians(45));
    private final Pose pickUp1Pose = new Pose(125, 83, Math.toRadians(0));
    private final Pose startPickUp2Pose = new Pose(86, 55, Math.toRadians(0));
    private final Pose endPickUp2Pose = new Pose(125, 55, Math.toRadians(0));
    private final Pose startPickUp3Pose = new Pose(86, 48, Math.toRadians(0));
    private final Pose endPickUp3Pose = new Pose(125, 48, Math.toRadians(0));
    private final Pose offWhiteLinePose = new Pose(86, 108, Math.toRadians(90));
...
//                robot.indexServo.setPosition(0);
            ...
            case 8: // Scores Pickup 2
                ...
                robot.indexServo.setPosition(0);
                if (System.currentTimeMillis() - storedTime >= 2000) {
                    robot.indexMotor.setPower(0.65);
                }
                if (System.currentTimeMillis() - storedTime >= 3500) {
                    robot.indexMotor.setPower(0);
                    deliveryPower = 0;
